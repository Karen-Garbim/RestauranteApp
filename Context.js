...
const Context = ({children}) => {
  ...
  return (
    <DataContext.Provider 
      value={{nomeProduto, setNomeProduto, descricaoProduto, setDescricaoProduto, valorProduto, setValorProduto, imagemProduto, setImagemProduto, produtos, setProdutos, total, setTotal, quantidade, setQuantidade}}>
      {children} 
    </DataContext.Provider>
  );
